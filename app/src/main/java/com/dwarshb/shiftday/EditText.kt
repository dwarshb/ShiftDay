...
fun EditText.asTimePicker(context: Context, format: String,onTimeEventSet: (Int,Int) -> Unit) {
    ...
    val timePickerOnTimeSetListener =
        TimePickerDialog.OnTimeSetListener { _, hour, minute ->
            ...
            onTimeEventSet(hour,minute)
        }

    setOnClickListener {
        TimePickerDialog(
            context, timePickerOnTimeSetListener, calendar.get(Calendar.HOUR_OF_DAY), calendar.get(
